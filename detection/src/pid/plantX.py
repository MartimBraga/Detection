...
class Position():
    ...
    def pose(self):
        ...
        D= 0.025
        pid = PID.PID(P, I, D)
        pid.SetPoint=0.0 #setpoint sistem = pose in meter
...
#timesampling must be equal to time per loop or slightly greater
