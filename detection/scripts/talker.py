...
class ImageListener:
    ...
    def imageDepthCallback(self, data):
        pub = rospy.Publisher('detect_locate', coordinate, queue_size=4)
        ...
        try:
            ...
            if self.intrinsics:
                ...
                line += '  Coordinate: %8.2f %8.2f %8.2f.' % (result[1], result[0], result[2])
...
def main():
    depth_image_topic = '/jackal0/realsense/depth/image_rect_raw'
    depth_info_topic = '/jackal0/realsense/depth/camera_info'
...
""" 
def talker():
    pub = rospy.Publisher('detection', Int32, queue_size=4)
    rospy.init_node('talker', anonymous=True)
